...
class Wrist : public IMechanism {
 public:
  ...
  void MoveWristPresets(PlacementHeights::PLACEMENT_HEIGHT height, bool cargo, bool flip, bool second);
 ...
 private:
  ...
  //                                   0, 1,     2,      3,      4,     5,     6,     7, 8
  double hatchAngle[MAX_HATCH_POS] = { 0, 51.38, -66.88, 150.40, 90.54, 27.54, 83.00, 0, 0 };                            
